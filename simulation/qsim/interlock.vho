...
-- Equation(s):
-- \Mux13~14_combout\ = (((!\Mux10~0\))) # (!\d1~combout\(3))
...
\Mux11~0\ : maxii_lcell
-- Equation(s):
-- \Mux11~0_combout\ = (!last_s1(3) & (!last_s1(1) & (!last_s1(0) & last_s1(2))))
...
-- Equation(s):
-- \Mux10~2\ = (\d1~combout\(3) & ((\Mux10~0\) # ((!\d1~combout\(2) & \Mux10~1_combout\))))
...
-- Equation(s):
-- \Mux13~16\ = (last_s1(2) & (\d1~combout\(2) & (!last_s1(3) & !last_s1[1]))) # (!last_s1(2) & ((last_s1(3) $ (last_s1[1]))))
...
-- Equation(s):
-- \Mux0~0\ = (last_s1(1) & (!last_s1(3) & (!last_s1[0] & !last_s1(2))))
...
-- Equation(s):
-- \Mux24~0\ = (!last_s2(0) & (!last_s2(2) & (last_s2[3] & !last_s2(1))))
...
\Mux25~0\ : maxii_lcell
-- Equation(s):
-- \Mux25~0_combout\ = (!last_s2(1) & (last_s2(2) & (!last_s2(3) & !last_s2(0))))
...
\Mux38~1\ : maxii_lcell
-- Equation(s):
-- \Mux38~1_combout\ = (((!\d3~combout\(0) & !\d3~combout\(1))))
...
-- Equation(s):
-- \Mux38~0\ = (!last_s3(0) & (!last_s3(2) & (last_s3[3] & !last_s3(1))))
...
\Mux39~0\ : maxii_lcell
-- Equation(s):
-- \Mux39~0_combout\ = (!last_s3(3) & (last_s3(2) & (!last_s3(0) & !last_s3(1))))
...
-- Equation(s):
-- \Mux41~17_combout\ = (!last_s3(0) & (\Mux41~16\ & ((\d3~combout\(3)) # (!last_s3(3)))))
...
-- Equation(s):
-- \Mux55~3\ = (last_s4[2] & (((last_s4(3))) # (!\d4~combout\(2)))) # (!last_s4[2] & (((!last_s4(3)) # (!\d4~combout\(3)))))
...
-- Equation(s):
-- \Mux55~15_combout\ = ((last_s4(0)) # ((last_s4(1)) # (\Mux55~3\)))
...
-- Equation(s):
-- \Mux42~0\ = (!last_s4(3) & (last_s4(1) & (!last_s4[0] & !last_s4(2))))
...
-- Equation(s):
-- \Mux55~16\ = (last_s4(2) & (\d4~combout\(2) & (!last_s4[1] & !last_s4(3)))) # (!last_s4(2) & ((last_s4[1] $ (last_s4(3)))))
...
-- Equation(s):
-- \Mux52~0\ = (!last_s4(2) & (!last_s4(0) & (last_s4[3] & !last_s4(1))))
...
-- Equation(s):
-- \Mux55~14_combout\ = (((!\Mux52~0\)) # (!\d4~combout\(3)))
...
\Mux53~0\ : maxii_lcell
-- Equation(s):
-- \Mux53~0_combout\ = (!last_s4(1) & (!last_s4(0) & (!last_s4(3) & last_s4(2))))
...
-- Equation(s):
-- \Mux69~3\ = (last_s5(3) & (((last_s5[2])) # (!\d5~combout\(3)))) # (!last_s5(3) & (((!\d5~combout\(2)) # (!last_s5[2]))))
...
-- Equation(s):
-- \Mux56~0\ = (!last_s5(3) & (!last_s5(2) & (!last_s5[0] & last_s5(1))))
...
\Mux67~0\ : maxii_lcell
-- Equation(s):
-- \Mux67~0_combout\ = (!last_s5(3) & (last_s5(2) & (!last_s5(1) & !last_s5(0))))
...
-- Equation(s):
-- \Mux66~0\ = (!last_s5(1) & (!last_s5(0) & (last_s5[3] & !last_s5(2))))
...
-- Equation(s):
-- \Mux69~14_combout\ = (((!\Mux66~0\)) # (!\d5~combout\(3)))
...
-- Equation(s):
-- \Mux69~16\ = (last_s5(2) & (!last_s5(3) & (\d5~combout\(2) & !last_s5[1]))) # (!last_s5(2) & (last_s5(3) $ (((last_s5[1])))))
...
-- Equation(s):
-- \Mux83~16\ = (last_s6(2) & (!last_s6(3) & (!last_s6[1] & \d6~combout\(2)))) # (!last_s6(2) & (last_s6(3) $ ((last_s6[1]))))
...
-- Equation(s):
-- \Mux80~0\ = (!last_s6(2) & (!last_s6(1) & (last_s6[3] & !last_s6(0))))
...
-- Equation(s):
-- \Mux83~14_combout\ = (((!\Mux80~0\))) # (!\d6~combout\(3))
...
\Mux81~0\ : maxii_lcell
-- Equation(s):
-- \Mux81~0_combout\ = (last_s6(2) & (!last_s6(0) & (!last_s6(1) & !last_s6(3))))
...
-- Equation(s):
-- \Mux97~3\ = (last_s7(3) & (((last_s7[2])) # (!\d7~combout\(3)))) # (!last_s7(3) & (((!\d7~combout\(2)) # (!last_s7[2]))))
...
-- Equation(s):
-- \Mux97~15_combout\ = ((last_s7(0)) # ((last_s7(1)) # (\Mux97~3\)))
...
-- Equation(s):
-- \Mux84~0\ = (!last_s7(3) & (!last_s7(2) & (!last_s7[0] & last_s7(1))))
...
-- Equation(s):
-- \Mux97~16\ = (last_s7(2) & (!last_s7(3) & (!last_s7[1] & \d7~combout\(2)))) # (!last_s7(2) & (last_s7(3) $ ((last_s7[1]))))
...
-- Equation(s):
-- \Mux94~0\ = (!last_s7(0) & (!last_s7(2) & (last_s7[3] & !last_s7(1))))
...
\Mux95~0\ : maxii_lcell
-- Equation(s):
-- \Mux95~0_combout\ = (!last_s7(0) & (!last_s7(3) & (!last_s7(1) & last_s7(2))))
...
PORT MAP (
	clk => \clk~combout\,
	dataa => \Mux94~1_combout\,
	datab => \Mux97~14_combout\,
	datac => \d7~combout\(2),
...
-- Equation(s):
-- \Mux98~0\ = (!last_s8(3) & (last_s8(1) & (!last_s8[0] & !last_s8(2))))
...
PORT MAP (
	...
	dataa => \d8~combout\(1),
	datab => \d8~combout\(0),
	datac => \Mux111~15_combout\,
	datad => \Mux111~17_combout\,
	aclr => GND,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \Mux111~13\,
...
-- Equation(s):
-- \Mux108~0\ = (!last_s8(0) & (!last_s8(2) & (last_s8[3] & !last_s8(1))))
...
-- Equation(s):
-- \Mux108~2\ = (\d8~combout\(3) & ((\Mux108~0\) # ((!\d8~combout\(2) & \Mux108~1_combout\))))
...
-- Equation(s):
-- \Mux109~0_combout\ = (!last_s8(3) & (!last_s8(1) & (last_s8(2) & !last_s8(0))))
...
-- Equation(s):
-- \Mux111~14_combout\ = (((!\Mux108~0\) # (!\d8~combout\(3))))
...
-- Equation(s):
-- \Mux111~15_combout\ = (last_s8(1)) # (((last_s8(0)) # (\Mux111~3\)))
